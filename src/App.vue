...
<div id="app" v-cloak>
  ...
  <div v-show ="journey.start" id = "longLength">
   <div class = "sectionOne section">
    <div v-for = "(element,index) in starPieces[0]" v-bind:class = "[ { starFollow : stars[0]} , 'star']" v-bind:key="index"></div>
  ...
  <div class="sectionTwo section" ref="sectionTwo">
        <div v-for = "(element,index) in starPieces[1]" v-bind:class = "[ { starFollow : stars[1]} , 'star']" v-bind:key="index"></div>

     <div v-if="journey.sectionTwo" class="monitor">
        <div v-for="(component, index) in capturedResponse.articles" class = "screen" style="display:none" v-bind:key="index">
    ...
    <div v-for = "(index) in screenStripes.Hori" v-show = "journey.sectionTwo" class="sectionHori-2" 
    v-bind:style = "{top:index.top, transform:index.ani,zIndex:index.zIndex}" v-bind:key="index"></div>
   <div v-for = "(index) in screenStripes.Vert" v-show = "journey.sectionTwo" class="sectionVert-2" 
  v-bind:style = "{left:index.left, transform:index.ani,zIndex:index.zIndex}" v-bind:key="index"></div>
  </div>
  <div class="sectionThree section" ref="sectionThree">
  <div v-for="(element,index) in starPieces[2]" v-bind:class="[ { starFollow : stars[2]} , 'star']" v-bind:key="index"></div>
...
<div v-if="cannonParts.one[2]" class="fireButton" @click="fireCannon"><div style="color:white;width:100%;text-align:center;position:absolute;top:40%;">FIRE!</div></div>
  ...
  <div v-for = "(element,index) in starPieces[3]" v-bind:class = "[ { starFollow : stars[3]} , 'star']" v-bind:key="index"></div>

  <div class = "catPictureContainer" ><img class="catPic"></div>
  <div class = "flipScreen">
  <div v-for = "(flip,index) in screenFlips" v-bind:class = "flip" v-bind:id = "index" v-bind:key="index" ></div>
